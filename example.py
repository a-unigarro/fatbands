...
viewer.plot_fatbands_symbol(band_list=list(range(150,250)), #### bands to plot
                                ...
                                l=1,ylims=[-2,2], 
                                symbol=['Si','C'], ### atoms set used for the orbital projection
                                symbol_m='Pb', ### atoms set used for the m-resolved orbital projection
...
viewer.plot_fatbands_atomsets(band_list=list(range(150,250)),  #### bands to plot
                                e0=2.77561, #### Fermi level
                                l=1, ### angular momentum to make the orbital projection 
                                ylims=[-2,2], 
                                atom_set=[0,1,2], ### atoms set used for the orbital projection
